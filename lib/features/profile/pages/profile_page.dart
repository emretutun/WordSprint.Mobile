...
class _ProfilePageState extends State<ProfilePage> {
  ...
  String _levelText(int level) {
    return ceLevelText(ceLevelFromInt(level));
  }
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              _infoTile(
                                Icons.flag_outlined,
                                "Günlük Hedef",
                                "${_profile!.dailyWordGoal} Kelime",
                              ),
                              _infoTile(
                                Icons.trending_up,
                                "Seviye",
                                _levelText(_profile!.level),
                              ),
                              ...
                              _actionTile(
                                Icons.edit_outlined,
                                "Profili Düzenle",
                                "İsim, fotoğraf, seviye ve hedeflerini güncelle",
                                () async {
        ...
        children: [
          CircleAvatar(
            ...
            child: CircleAvatar(
              radius: 52,
              backgroundImage:
                  _profile!.photoUrl.isNotEmpty ? NetworkImage(_profile!.photoUrl) : null,
